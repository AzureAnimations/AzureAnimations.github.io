...
(function (global) {
  ...
  function isControl(e) {
    const t = e.target;
    return !!(t && t.closest && t.closest('button,a[href],summary,[role="button"],[role="switch"],[role="link"]'));
  }
    ...
    bind(handlers) {
      function onKey(e) {
        ...
        if (e.code === 'Space' || e.code === 'ArrowRight' || e.code === 'Enter') {
          if ((e.code === 'Space' || e.code === 'Enter') && isControl(e)) return;
