# Narrator Script — Azure Security Journey · Hub

**Source page:** `static/v2/Security/index.html`

Tags in `[brackets]` are delivery cues — speaking styles, paralinguistics, and `[NNNms]` pause
markers. The hub has a single welcome clip.
